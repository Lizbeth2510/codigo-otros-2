...
var formulario = document.querySelector(".formulario"); //llamr por clase y el nombre correcto de la misma
formulario.onsubmit = function(e) {
  // Prevenir la recarga de la página al enviar el formulario
  e.preventDefault();  //la propiedad es preventDefault no solo prevent

  // Obtener elementos del formulario--> se asignaron los nombres más especificos para la lectura del codigo y los que se ocupan más tarde
...
function agregarInvitado(nombre, edad, nacionalidad) {
  ...
  var nacionalidadMap = {
    ...
    vnzl: "Venezolana",
    per: "Peruana"
  }; //cambio de estructura por mapeo para sintetizar y hacer más legible el código
  ...
  elementoLista.classList.add("elemento-lista"); //la propiedad correcta es add 
  ...
  }; //funciónalidad efectiva del botonpara eliminar
}